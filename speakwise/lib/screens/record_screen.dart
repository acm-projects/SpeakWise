...
class RecordPage extends StatelessWidget {
 ...
 Color tdBGcolor = Color.fromARGB(255, 129, 185, 238);
 Color pinkish = Color.fromARGB(255,249,194,170); 
 Color whitishBg = Color.fromARGB(255, 239, 237, 231);
 Color darkBlueLogoColor = Color.fromARGB(255, 7, 39, 101);
